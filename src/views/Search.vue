<template>
  ...
  <el-input placeholder="请输入内容" v-model="input3" class="searchinput input-with-select">
    ...
    <i slot="suffix" class="el-input__icon el-icon-search search-button"></i>
  </el-input>
  <div class="choose"><span>论文</span><span class="zhuanjia">专家</span></div>
</div>
...
<div class="searchbody"><el-row :gutter="20">
  ...
  <el-collapse-item>
    ...
    <i style="float:right;margin-top:7px" class="el-icon-search"></i>
  </el-collapse-item>
  </el-collapse>
  </div>
    </el-col>
